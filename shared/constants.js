...
export const BOT_DETECTION_RANGE = 30;        // distanza per "vedere" il player (bot aggressivo)
export const BOT_SHORT_DETECTION_RANGE = 16;  // distanza per "vedere" il player (bot strategico)
...
export const BOT_AIM_ERROR = 0.25;            // radianti errore mira max
